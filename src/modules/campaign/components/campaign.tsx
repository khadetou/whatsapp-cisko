...
const CampaignComponent: FC<OurCampaignProps> = ({
  campaigns: {
    booksCampaignGoals,
    booksCampaignRaised,
    booksCampaignText,
  ...
  return (
    <section className="our-campaign !tw-bg-white">
              ...
              <div className="donation-bottom-description">
                ...
                <div className="donation-progress-bar">
                  ...
                  <Link
                    ...
                    href="/campaigns/supportEducation"
                  >
                    {btnDonate}
                  </Link>
                </div>
            ...
            >
              ...
              <div className="donation-bottom-description">
                ...
                <div className="donation-progress-bar">
                  ...
                  <Link className="btn-donate" href="/campaigns/sustainability">
                    {btnDonate}
                  </Link>
                </div>
              </div>
            ...
            >
              ...
              <div className="donation-bottom-description">
                ...
                <div className="donation-progress-bar">
                  ...
                  <Link
                    className="btn-donate"
                    href="/campaigns/villageAutonome"
                  >
                    {btnDonate}
                  </Link>
                </div>
